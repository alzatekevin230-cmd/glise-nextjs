...
export default function ProductCardSimple({ product, isSmall = false }) {
  ...
  const buttonClasses = `w-full text-white font-bold rounded-lg transition flex items-center justify-center ${isSmall ? 'py-1 px-2 text-xs' : 'py-2 px-4'} ${isOutOfStock ? 'btn-disabled' : 'bg-cyan-700 hover:bg-cyan-800'}`;
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden product-card flex flex-col text-center border h-full relative group">
