  ...
  return (
    ...
    <section className="container mx-auto px-2 sm:px-6 my-8 md:hidden">
      <div className="grid grid-cols-2 gap-4">
        ...
        <Link href="/producto/62" className="promo-card-mobile promo-card--tall bg-blue-50">
        ...
        <Link href="/categoria/Milenario" className="promo-card-mobile promo-card--tall bg-green-50">
          <div className="promo-card-content">
        ...
        <Link href="/producto/198" className="promo-card-mobile promo-card--wide col-span-2 bg-yellow-50">
          <div className="promo-card-content">
